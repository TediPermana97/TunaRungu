...
public class MateriTutorLimaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_tutor_lima);
        ...
        mJTv3.setText(getResources().getString(R.string.tutorial5));
