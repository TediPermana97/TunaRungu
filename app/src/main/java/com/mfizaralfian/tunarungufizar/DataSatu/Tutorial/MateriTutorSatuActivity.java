...
public class MateriTutorSatuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_tutor_satu);
        ...
        mJTv3.setText(getResources().getString(R.string.tutorial1));
