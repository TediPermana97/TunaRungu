package com.mfizaralfian.tunarungufizar.DataSatu.Materi;
...
public class MateriEmpatActivity extends AppCompatActivity {
    private JustifiedTextView mJTv, mJTv2, mJTv3;
    ImageView kembali;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_materi_empat);
        ...
        mJTv3.setText(getResources().getString(R.string.materi4));
