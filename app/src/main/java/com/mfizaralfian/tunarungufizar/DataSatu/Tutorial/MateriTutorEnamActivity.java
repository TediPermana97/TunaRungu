...
public class MateriTutorEnamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_tutor_enam);
        ...
        mJTv3.setText(getResources().getString(R.string.tutorial6));
