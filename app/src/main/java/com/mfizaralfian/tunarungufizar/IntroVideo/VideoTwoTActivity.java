...
import com.mfizaralfian.tunarungufizar.Tutor.TutorSatuActivity;
...
public class VideoTwoTActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_two_t);
...
//        lp.flags |= WindowManager.LayoutParams.FLAG_FULLSCREEN;
    ...
    public void onClickdasboard1(View v) {
        Intent i = new Intent(this, TutorSatuActivity.class);
