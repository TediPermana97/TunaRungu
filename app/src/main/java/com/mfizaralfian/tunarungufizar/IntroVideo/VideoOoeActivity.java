package com.mfizaralfian.tunarungufizar.IntroVideo;
...
import com.mfizaralfian.tunarungufizar.DataDua.DaftarVideoActivity;
import com.mfizaralfian.tunarungufizar.DataDua.TutorialVideoSatuActivity;
...
public class VideoOoeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_ooe);
...
//        lp.flags |= WindowManager.LayoutParams.FLAG_FULLSCREEN;
    ...
    //---------------------pindah-------------------------
    public void onClickdasboard1(View v) {
        Intent i = new Intent(this, DaftarVideoActivity.class);
